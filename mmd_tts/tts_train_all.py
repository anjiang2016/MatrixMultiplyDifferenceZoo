...
# 7. 参数初始化
# ============================================================
def init_tts_params(vocab_size, embed_dim=128, num_heads=8, num_encoder_layers=3, num_decoder_layers=3,mel_dim=80, max_seq_len=200,dropout_rate=1.0,post_net_channels=512):
    head_dim = embed_dim // num_heads
